(function (ext) {
	...
	ext.setServo = function (servo, angle) {
		...
		var nStringValue = angle.toString();
		while (nStringValue.length<3) {
			nStringValue = "0"+nStringValue;
		}
		
		sendServo = sendServo.replaceAt(3,nStringValue.charAt(0));
		sendServo = sendServo.replaceAt(4,nStringValue.charAt(1));
		sendServo = sendServo.replaceAt(5,nStringValue.charAt(2));
