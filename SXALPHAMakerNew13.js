(function (ext) {
	...
	ext.setServo = function (servo, angle) {
		...
		sendServo = sendServo.replaceAt(3,String.fromCharCode(Math.floor(angle / 100 + 48)));
		sendServo = sendServo.replaceAt(4,String.fromCharCode(Math.floor((angle % 100) / 10 + 48)));
		sendServo = sendServo.replaceAt(5,String.fromCharCode(Math.floor(angle % 10 + 48)));
	...
	ext.setMotor = function (motor, direction, power) {
		...
		sendMotor = sendMotor.replaceAt(3,fromCharCode(Math.floor(power / 100 + 48)));
		sendMotor = sendMotor.replaceAt(4,fromCharCode(Math.floor((power % 100) / 10 + 48)));
		sendMotor = sendMotor.replaceAt(5,fromCharCode(Math.floor(power % 10 + 48)));
	...
	ext.playNote = function (note) {
		...
		sendSound = sendSound.replaceAt(3,String.fromCharCode(Math.floor(value / 100 + 48)));
		sendSound = sendSound.replaceAt(4,String.fromCharCode(Math.floor((value % 100) / 10 + 48)));
		sendSound = sendSound.replaceAt(5,String.fromCharCode(Math.floor(value % 10 + 48)));
